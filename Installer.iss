...
[Registry]
; Comics
Root: HKA; Subkey: "Software\Classes\ComicRack.eComic";                       ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "eComic"
Root: HKA; Subkey: "Software\Classes\ComicRack.eComic\DefaultIcon";           ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: """{autopf}\{#MyAppName}\{#MyAppExeName}"",1"
Root: HKA; Subkey: "Software\Classes\ComicRack.eComic\shell";                 ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "open"
Root: HKA; Subkey: "Software\Classes\ComicRack.eComic\shell\open";            ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "Open eComic with ComicRack CE"
Root: HKA; Subkey: "Software\Classes\ComicRack.eComic\shell\open\command";    ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: """{autopf}\{#MyAppName}\{#MyAppExeName}""  ""%1"""

; Comic Lists
Root: HKA; Subkey: "Software\Classes\ComicRack.ComicList";                    ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "eComic List"
Root: HKA; Subkey: "Software\Classes\ComicRack.ComicList\DefaultIcon";        ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: """{autopf}\{#MyAppName}\{#MyAppExeName}"",2"
Root: HKA; Subkey: "Software\Classes\ComicRack.ComicList\shell";              ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "open"
Root: HKA; Subkey: "Software\Classes\ComicRack.ComicList\shell\open";         ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "Import eComic List into ComicRack CE"
Root: HKA; Subkey: "Software\Classes\ComicRack.ComicList\shell\open\command"; ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: """{autopf}\{#MyAppName}\{#MyAppExeName}"" -il ""%1"""

; ComicRack Plugins
Root: HKA; Subkey: "Software\Classes\ComicRack.Plugin";                       ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack Plugin"
Root: HKA; Subkey: "Software\Classes\ComicRack.Plugin\DefaultIcon";           ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: """{autopf}\{#MyAppName}\{#MyAppExeName}"",3"
Root: HKA; Subkey: "Software\Classes\ComicRack.Plugin\shell";                 ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "open"
Root: HKA; Subkey: "Software\Classes\ComicRack.Plugin\shell\open";            ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "Install Plugin into ComicRack CE"
Root: HKA; Subkey: "Software\Classes\ComicRack.Plugin\shell\open\command";    ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: """{autopf}\{#MyAppName}\{#MyAppExeName}"" -ip ""%1"""

; Extensions
Root: HKA; Subkey: "Software\Classes\.cbz";                                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbz\OpenWithProgIDs";                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueName: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbr";                                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbr\OpenWithProgIDs";                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueName: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cb7";                                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cb7\OpenWithProgIDs";                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueName: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbt";                                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbt\OpenWithProgIDs";                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueName: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbw";                                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbw\OpenWithProgIDs";                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueName: "ComicRack.eComic"
Root: HKA; Subkey: "Software\Classes\.cbl";                                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack.ComicList"
Root: HKA; Subkey: "Software\Classes\.cbl\OpenWithProgIDs";                   ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueName: "ComicRack.ComicList"
Root: HKA; Subkey: "Software\Classes\.crplugin";                              ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueData: "ComicRack.Plugin"
Root: HKA; Subkey: "Software\Classes\.crplugin\OpenWithProgIDs";              ValueType: string; Flags: uninsdeletevalue; Components: associate; ValueName: "ComicRack.Plugin"
